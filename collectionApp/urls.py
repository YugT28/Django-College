...
from .views import show,student_filter,faculty_filter,result_filter_course,result_filter_branch,result_filter_student,result,showcourse,faculty,addResult
urlpatterns = [
